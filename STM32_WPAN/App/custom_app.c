...
void Custom_STM_App_Notification(Custom_STM_App_Notification_evt_t *pNotification)
{
  ...
  switch (pNotification->Custom_Evt_Opcode)
  {
    ...
    case CUSTOM_STM_BUTTON_C_NOTIFY_ENABLED_EVT:
      ...
      Custom_App_Context.Button_c_Notification_Status = 1;        /* My_Switch_Char notification status has been enabled */
    ...
    case CUSTOM_STM_BUTTON_C_NOTIFY_DISABLED_EVT:
      ...
      Custom_App_Context.Button_c_Notification_Status = 0;        /* My_Switch_Char notification status has been disabled */
...
/* My_P2P_Server */
__USED void Custom_Button_c_Update_Char(void) /* Property Read */
{
...
void Custom_Button_c_Send_Notification(void) /* Property Notification */
{
  ...
  /* USER CODE BEGIN Button_c_NS_1*/

  /* USER CODE END Button_c_NS_1*/
  ...
  /* USER CODE BEGIN Button_c_NS_Last*/

  /* USER CODE END Button_c_NS_Last*/
